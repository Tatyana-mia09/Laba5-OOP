...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        /*list.add(new NoteBook("Пн",LocalTime.parse("09:00:00"),
                "Лекция ООП","Шибеко Викор Николаевич",0.0));
        list.add(new NoteBook("Вт",LocalTime.parse("09:00:00"),
                "Лекция ООП","Шибеко Викор Николаевич",13.12));
        list.add(new NoteBook("Ср",LocalTime.parse("09:00:00"),
                "Лекция ООП","Шибеко Викор Николаевич",110.20));
        list.add(new NoteBook("Чт",LocalTime.parse("09:00:00"),
                "Лекция ООП","Шибеко Викор Николаевич",210.0));
        list.add(new NoteBook("Пт",LocalTime.parse("09:00:00"),
                "Лекция ООП","Шибеко Викор Николаевич",111.1));
        list.add(new NoteBook("Сб",LocalTime.parse("09:00:00"),
                "Лекция ЯПВУ","Шибеко Викор Николаевич",12.0));
        list.add(new NoteBook("Вс",LocalTime.parse("09:00:00"),
                "Лекция ООП","Шибеко Викор Николаевич",11.11));
        list.add(new NoteBook("Пн",LocalTime.parse("09:00:00"),
                "Лекция ООП","Шибеко Викор Николаевич",30.50));
        list.add(new NoteBook("Пн",LocalTime.parse("09:00:00"),
                "Лекция ООП","Шибеко Викор Николаевич",0.0));*/

        //FileProcessing.fileWrite(list); ЕСЛИ ЗАХОЧЕШЬ ПОМЕНЯТЬ ДАННЫЕ, ЭТОТ МЕТОД ЗАПИШЕТ ДАННЫЕ В ФАЙЛ
